    ...
    return (
      <div className="w-full flex flex-col gap-1.5">
        ...
        <select
          ...
          className={`w-full bg-bone border rounded-none p-3.5 font-sans text-sm text-graphite transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-olive focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed ${
