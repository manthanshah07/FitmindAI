...
- **P3-2 (Password Complexity Validation):** RESOLVED — Extended `RegisterRequest` schema with password validator requiring letters and digits.
- **P3-3 (Rate Limit Refresh Endpoint):** RESOLVED — Added rate limit decorator to `/auth/refresh`.
